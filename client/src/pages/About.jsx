            ...
            <div className="block mt-3 font-sans text-xl antialiased font-normal leading-relaxed text-gray-700">
              <ul className="list-disc ml-5">
                <li>
                  ...
                  plant needs at least six hours (but sometimes closer to eight
                  or ten hours) of direct sunlight in a day.
                </li>
                <div className="block mt-3 font-sans text-xl antialiased font-normal leading-relaxed text-gray-700"></div>
                <li>
                ...
                <li>
                  ...
                  plants enjoy environments that receive only indirect sunlight
                  or less than three hours of direct sunlight per day.
                </li>
                <div className="block mt-3 font-sans text-xl antialiased font-normal leading-relaxed text-gray-700"></div>
                <li>
          ...
          <p className="block mt-3 font-sans text-xl antialiased font-normal leading-relaxed text-gray-700">
            ...
            <ul className="list-disc ml-5">
              ...
              <li>
                ...
                the soil an inch below the surface moist. Allow the top inch of
                soil – but no more – to dry out before watering again.
              </li>
              <div className="block mt-3 font-sans text-xl antialiased font-normal leading-relaxed text-gray-700"></div>
              <li>
