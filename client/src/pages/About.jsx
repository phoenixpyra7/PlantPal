...
const About = ({}) => {
    ...
    return (
      ...
      <ul className="list-disc ml-5">
		    <li>Full sun: Usually depicted by a sun icon, full sun means the plant needs at least six hours (but sometimes closer to eight or ten hours) of direct sunlight in a day.
        </li>
        <div className="block mt-3 font-sans text-xl antialiased font-normal leading-relaxed text-gray-700"></div>
		    <li>Partial sun/shade: This icon appears as a half-shaded sun. Plants that require partial sun need four to six hours of direct sunlight per day.
       </li>
       <div className="block mt-3 font-sans text-xl antialiased font-normal leading-relaxed text-gray-700"></div>
        <li>Full shade: Plants that need full shade will have a sun icon that is completely shaded in on their plant tags. Full shade plants enjoy environments that receive only indirect sunlight or less than three hours of direct sunlight per day.
        </li>
        <div className="block mt-3 font-sans text-xl antialiased font-normal leading-relaxed text-gray-700"></div>
		    <li>Direct or Indirect sunlight: Some plants need a lot of indirect sunlight which means it is near a window or a brightly lit room but not in direct path of the sun. Some plants can get sunburn ELABORATE HERE****. 
        </li>
      </ul>    
		</div>
    </p>
    ...
    <br>
        ...
        <div className="block mt-3 font-sans text-xl antialiased font-normal leading-relaxed text-gray-700"></div>
		    <li>Normal: Often indicated by two raindrops, normal means keeping the soil an inch below the surface moist. Allow the top inch of soil – but no more – to dry out before watering again.
        </li>
        <div className="block mt-3 font-sans text-xl antialiased font-normal leading-relaxed text-gray-700"></div>
		    <li>Moist: Moist soil or three raindrops means the soil should always stay moist. Water frequently to prevent the soil from drying out, but do not water to the point that excess water pools on the surface of the soil.
       </li>
       </ul>
        </p>
        <p className="block mt-3 font-sans text-xl antialiased font-normal leading-relaxed text-gray-700">
        ...
        <p className="block mt-3 font-sans text-xl antialiased font-normal leading-relaxed text-gray-700">
        Some plants may bloom during certain seasons or may bloom across multiple seasons. Some plants produce ELABORATE HERE *******. 
        </p>
        <div className="block mt-3 font-sans text-xl antialiased font-normal leading-relaxed text-gray-700"></div>
        <br>
        </br>
        ...
        <p className="block mt-3 font-sans text-xl antialiased font-normal leading-relaxed text-gray-700">
          Some plants go into hybernation or a perios of rest. They may lose all of their leaves and appear as though they have died but this is not the case. Plants that ELABORATE HERE *****
        </p>
      </div>
